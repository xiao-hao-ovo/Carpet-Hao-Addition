...
public final class DirectDropContext {
	private static final ThreadLocal<ArrayList<ServerPlayer>> STACK = new ThreadLocal<>();
	 ...
	 */
	public static void push(ServerPlayer owner) {
		ArrayList<ServerPlayer> stack = STACK.get();
		if (stack == null) {
