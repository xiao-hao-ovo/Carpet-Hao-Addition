 ...
 * {@code AbstractBlockState.calcBlockBreakingDelta} 的 RETURN 处兜底,但其它扩展
 * (典型是 Carpet-AMS-Addition 的 {@code commandCustomBlockHardness})会在该方法
 * <b>HEAD</b> 处直接 {@code setReturnValue} 并取消,方法提前返回,Return 注入被整段跳过。
 * <p>
...
public abstract class ClientPlayerInteractionManager_bedrockMinesMixin {
	@WrapOperation(method = "updateBlockBreakingProgress", at = @At(value = "INVOKE",
	...
	private float hao$bedrockDeltaClient(BlockState state, PlayerEntity player, BlockView world, BlockPos pos,
